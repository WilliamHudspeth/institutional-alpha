...
from iam.data.security import Security, Fundamentals
...
def test_verdict_generator_downgrades_high_leverage():
    ...
    tri = TriangulationResult(verdict="agree", confidence=0.9, cluster_center=0.25, cluster_members=[], outliers=[], notes=[])
