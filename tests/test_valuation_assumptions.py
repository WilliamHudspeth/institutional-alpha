...
def test_assumption_distribution_sources():
    ad = AssumptionDistribution(name="growth", historical_cagr=0.10, sustainable_growth=0.08)
...
def test_confidence_score():
    ...
    multi_ad = AssumptionDistribution(
        name="multi", historical_cagr=0.10, sustainable_growth=0.10, bottom_up=0.10
    )
