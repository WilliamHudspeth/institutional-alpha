...
def test_edgar_assembles_debt_from_current_plus_noncurrent():
    edgar = _edgar_with({
        ...
        "DebtCurrent.json": {"units": {"USD": [
            {"end": "2024-03-30", "val": 1.0e10, "filed": "2024-05-02"},
        ]}},
        "LongTermDebtNoncurrent.json": {"units": {"USD": [
...
def test_edgar_point_in_time_excludes_unfiled_data():
    ...
    edgar = _edgar_with({
        ...
        "DebtCurrent.json": {"units": {"USD": [
            ...
            {"end": "2024-06-29", "val": 9.9e9, "filed": "2024-08-01"},   # filed AFTER as_of
        ]}},
        "LongTermDebtNoncurrent.json": {"units": {"USD": [
            {"end": "2023-12-30", "val": 8.0e10, "filed": "2024-02-01"},
            {"end": "2024-06-29", "val": 9.9e10, "filed": "2024-08-01"},  # not yet filed
        ]}},
    })
